...
### 更新
- **AI 模型升级**
  - 默认对话模型从 `gpt-4.1-mini` 更新为 `gpt-5.4-mini`
  - 将无效的模型 ID 替换为正确的 GPT-5.4 系列：
    - `gpt-5-nano` → `gpt-5.4-nano`
    - `gpt-5-mini` → `gpt-5.4-mini`
    - `gpt-5.2` → `gpt-5.4`
  - 移除不存在的 TTS 模型 `gpt-4o-mini-tts-2025-12-15`
  - 保留 `gpt-4.1-nano`、`gpt-4.1-mini`、`gpt-4.1`、`gpt-4o-mini` 以向后兼容
