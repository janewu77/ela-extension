  ...
  describe("状态管理", () => {
    describe("initializeState", () => {
      ...
      it("应该处理存储读取错误", async () => {
        ...
        expect(console.error).toHaveBeenCalledWith("[Content] Error loading initial state:", error);
        expect(content.getCurrentOnoff()).toBe(false);
      });
    });
  ...
  describe("文本选择处理", () => {
    describe("getSelectedText", () => {
      ...
      it("应该处理获取选中文本时的错误", () => {
        ...
        expect(console.error).toHaveBeenCalledWith("[Content] Error getting selected text:", error);
        expect(result).toBe("");
      });
    ...
    describe("sendSelectedText", () => {
      ...
      it("应该处理发送消息时的错误", async () => {
        ...
        expect(console.error).toHaveBeenCalledWith("[Content] Error sending message:", error);
      });
    });
